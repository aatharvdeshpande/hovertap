...
urlpatterns = [
    ...
    path('Upload/', views.student_account_generations, name = "student_account_generations"),
    # path('UploadTeacher/', views.teacher_account_generations, name = "teacher_account_generations"),
